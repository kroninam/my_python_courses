...
# Перед вами имеется список словарь persons. Изучите внимательно все элементы списка,
# у них имеется одинаковый набор ключей. Ваша задача на основании списка persons отобрать
# информацию о номерах телефона и сложить их в отдельный список phones. Номера в списке
# phones должны располагаться в том же порядке, в котором расположены их владельцы в списке persons.
#
