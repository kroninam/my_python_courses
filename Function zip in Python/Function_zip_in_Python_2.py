...
# Отдел кадров просит вас создать словарь employees_data, в котором, ключами будут идентификаторы,
# а значениями - имена работников.
...
# В итоге у вас должен получится словарь employees_data
